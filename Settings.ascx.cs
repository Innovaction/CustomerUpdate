...
namespace Innovaction.Modules.CustomerUpdate
{
    ...
    /// 
    /// Because the control inherits from CustomerUpdateSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : CustomerUpdateModuleSettingsBase
    {
